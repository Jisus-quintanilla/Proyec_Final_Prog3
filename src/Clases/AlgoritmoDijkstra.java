...
public class AlgoritmoDijkstra {
    ...
    public void dijkstra() {
        for (int i = 0; i < tope; i++) // creacion del vector nodo del tamaño del numero de nodos pintados 
        {
            ...
            do {
                subtotalAcomulado = 0;
                auxiliarAumulado = 2000000000; // lo igualamos a esta cifra ya que el acomulado de los nodos, a la que nunca sera mayor 
                ...
                for (int i = 0; i < tope; i++) { // buscamos el más corto entre los acumulados
            ...
            while (Nodoauxiliar.getPredecesor() != null) {
                PintanrDibujos.pinta_Camino(jPanel1.getGraphics(), 
                        ...
                        arboles.getCordeY(Nodoauxiliar.getPredecesor().getNombre()), Color.YELLOW);
                
                PintanrDibujos.seleccionNodo(jPanel1.getGraphics(), 
                        arboles.getCordeX(Nodoauxiliar.getNombre()), 
                        arboles.getCordeY(Nodoauxiliar.getNombre()), null, Color.YELLOW);
